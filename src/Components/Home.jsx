          ...
          <div className="col-lg-6 slider-content ">
            <div className="slider-sec ">
              ...
              <p className=" mt-5 p-2" style={{ fontSize: 17 }}>
                At IMC, we are your compass on the path to a successful career
                in medical coding. Our mission is to provide you with the
                knowledge and skills required to excel in this dynamic field of
                healthcare.
              </p>
              <Link
              ...
              <div className="download-app-wrapper mt-n6">
                <div className="section-title section-title-white">
                  ...
                  <p className="text-white journey">
                    ...
                    Join us and begin an exciting journey toward a prosperous
                    and fulfilling career in medical coding.
                  </p>
                </div>
                {/* <img
                ...
                alt="Shape"
              /> */}
                <div className="graduation-cap-img pt-3 pt-md-0">
      ...
      <div className="container ">
        <div className="row ptb-30">
          <div className="section section-padding download-section">
            ...
            <div className="container">
              <div className="download-app-wrapper mt-n6">
                <div className="section-title section-title-white pb-3 pb-md-0">
                  ...
                  <p className="text-white journey">
                    ...
                    support your aspirations in the realm of medical coding.
                    We're thrilled to be your partner in success.
                  </p>
                </div>
                <img
                  className="shape-1 animation-right "
